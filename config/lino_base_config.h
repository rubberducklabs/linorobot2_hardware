...
#define MOTOR_MAX_RPM 16000                 // motor's max RPM
#define MAX_RPM_RATIO 0.85                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO
#define MOTOR_OPERATING_VOLTAGE 48          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 48          // max voltage of the motor's power source (used to calculate max RPM)
...
#define MOTOR1_PWM 22 // Pin no 21 is not a PWM pin on Teensy 4.x, you can use pin no 1 instead.
